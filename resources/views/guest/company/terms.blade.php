        ...
        <section class="bg-light" id="about-section">
            ...
            <div class="container">
                ...
                <div class="text-left page-title">
                    <h1 class="font-weight-bold display-4 text-theme-1 ml-3">Welcome to Online Aashirvaad</h1>
                    <p class="description-1 ml-3 text-secondary">These terms of service outline the rules and
                        regulations for the use of Online Aashirvaad's Website.</p>
                ...
                <div class="content mx-3">
                    <p>By accessing this website we assume you accept these terms of service in full. Do not continue to
                        use Online Aashirvaad's website
                    ...
                    <div>
                        <h5>Cookies</h5>
                        <p>We employ the use of cookies. By using Online Aashirvaad's website you consent to the use of
                            cookies
                            in accordance with Online Aashirvaad's privacy policy.Most of the modern day interactive web
                            sites
                    ...
                    <div>
                        <h5>License</h5>
                        <p>Unless otherwise stated, Online Aashirvaad and/or it's licensors own the intellectual
                            property rights for
                            all material on Online Aashirvaad. All intellectual property rights are reserved. You may
                            view and/or print
                            pages from https://onlineaashirvaad.com for your own personal use subject to restrictions
                            set in these terms of service.
                        </p>
                        <ul class="ml-4">
                            You must not:
                            <li>Republish material from https://onlineaashirvaad.com</li>
                            <li>Sell, rent or sub-license material from https://onlineaashirvaad.com</li>
                            <li>Reproduce, duplicate or copy material from https://onlineaashirvaad.com</li>
                        </ul>
                        <p>Reproduce, duplicate or copy material from https://onlineaashirvaad.com</p>
                    </div>
                    <div>
                        ...
                        <ul class="ml-4">
                            ...
                            <li>(a) the link would not reflect
                            ...
                            <li>(c) the benefit to us from
                                the visibility associated with the hyperlink outweighs the absence of Online Aashirvaad;
                            </li>
                            <li>
                                and (d) where the
                        ...
                        <ul class="ml-4">
                            ...
                            <li>(b) does not falsely imply sponsorship, endorsement or approval
                                of the linking party and it products or services;
                            </li>
                            <li>and (c) fits within the context of the linking party's
                                site.
                            </li>
                        </ul>
                        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking
                            to our website,
                            you must notify us by sending an e-mail to onlineaashirvaad@gmail.com.
                        </p>
                        <p>Please include your name, your organization name, contact information (such as a phone number
                            and/or e-mail
                        ...
                        <p>No use of Online Aashirvaad's logo or other artwork will be allowed for linking absent a
                            trademark license
                            agreement.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p>We reserve the right at any time and in its sole discretion to request that you remove all
                            ...
                            request. We also
                            reserve the right to amend these terms of service and its linking policy at any time. By
                            continuing
                    ...
                    <div>
                        ...
                        <ul class="ml-4">
                            ...
                            <li>(a)
                                are subject to the preceding paragraph; </li>
                            <li>and (b) govern all liabilities arising under the disclaimer or
                    ...
                    <p>For any query related to this privacy policy, you can send us a message through contact us page.</p>
                </div>
            </div>
            <br>
        </section>
