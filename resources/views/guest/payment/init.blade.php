                        ...
                        <form id="store_payment_form" action="{{route('gift.store')}}">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>Amount</th>
                                    <td>
                                        <input type="text" name="amount" id="amount" class="form-control" minlength="3"
                                               maxlength="10"
                                               pattern="[0-9]+"
                            ...
                            <p>By clicking on this button, you provide your consent to share your name, company name and
                                address with NAME.</p>
