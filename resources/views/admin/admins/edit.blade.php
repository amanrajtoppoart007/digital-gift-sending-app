                ...
                <div class="col-6">
                    <div class="form-group">
                        <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                            ...
                            <input class="form-check-input" type="checkbox" name="approved" id="approved" value="1" {{ $admin->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <div class="form-check {{ $errors->has('verified') ? 'is-invalid' : '' }}">
                            ...
                            <input class="form-check-input" type="checkbox" name="verified" id="verified" value="1" {{ $admin->verified || old('verified', 0) === 1 ? 'checked' : '' }}>
